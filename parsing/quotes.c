...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/21 13:40:20 by ahamadi           #+#    #+#             */
/*   Updated: 2025/08/01 20:29:41 by ahamadi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*handle_double_quote_char(struct s_shell *shell, char **cmd,
		...
		t_quote_buffer *qb, bool in_del)
{
	while (**cmd && **cmd != '"')
	{
		if (!handle_double_quote_char(shell, cmd, qb, in_del))
			return (NULL);
	}
	if (**cmd != '"')
	{
